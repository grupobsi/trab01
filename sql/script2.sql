...
DROP TABLE IF EXISTS SUPERMERCADO_PREFERENCIA_ADMINISTRADOR;

DROP TABLE IF EXISTS PRODUTO_CONSUMO_MEDIO_ADMINISTRADOR;

DROP TABLE IF EXISTS PRODUTO_CONSUMO_MEDIO_CLIENTE;

DROP TABLE IF EXISTS MENSAGENS_ADMINISTRADOR;
...
DROP TABLE IF EXISTS PRODUTO_UNID;
